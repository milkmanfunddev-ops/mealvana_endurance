...
void main() {
  ...
  group('SyncableRepository Interface', () {
    test('repositoryKey should return "carb_loading_plans"', () {
    ...
    test('dependencies should return ["users", "events"]', () {
      final mockSupabase = MockSupabaseClient();
      final repository = CarbLoadingRepository(
        supabase: mockSupabase,
        database: database,
  ...
  // - syncFromRemote(): Fetches carb loading plans/days from Supabase and saves to Drift
  // - uploadDirtyRecords(): Uploads dirty plans/days to Supabase and clears flags
  // - Multi-table sync (plans → days)
  ...
  // - Cascade syncing of related tables (plans and days)
}

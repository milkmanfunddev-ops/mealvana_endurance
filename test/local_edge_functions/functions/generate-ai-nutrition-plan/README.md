...
This directory contains **unit tests and local edge function tests** for the `generate-ai-nutrition-plan` Supabase edge function.
...
```bash
# Run all generate-ai-nutrition-plan local tests
npm test -- functions/generate-ai-nutrition-plan
...
For **integration tests** with real Supabase data, see: `/test/integration/edge/generate-ai-nutrition-plan/`
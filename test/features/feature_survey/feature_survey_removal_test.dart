...
void main() {
  group('Feature Survey Removal Verification', () {
    test(
      'should not find any feature_survey imports in lib directory',
      () async {
        ...
        final dartFiles = libDir
            ...
            .where(
              (file) => !file.path.contains('schema_versions.dart'),
            ) // Exclude schema versions (generated)
            .toList();
        ...
        expect(
          ...
          isEmpty,
          reason:
              'No files should contain feature_survey references.\n'
    ...
    test('should not find feature_survey directory in lib/features', () {
      final currentDir = Directory.current;
      final featureSurveyDir = Directory(
        '${currentDir.path}/lib/features/feature_survey',
      );
    ...
    test('should not find feature_survey_responses_table.dart', () {
      ...
      final tableFile = File(
        '${currentDir.path}/lib/shared/database/tables/feature_survey_responses_table.dart',
      );
    ...
    test(
      'should not find feature_survey in upload-all-data edge function',
      () async {
        final currentDir = Directory.current;
        final edgeFunctionFile = File(
          '${currentDir.path}/supabase/functions/upload-all-data/index.ts',
        );
        ...
        expect(
          ...
          isFalse,
          reason:
              'upload-all-data edge function should not reference feature_survey_responses',
        );
      },
    );
  });

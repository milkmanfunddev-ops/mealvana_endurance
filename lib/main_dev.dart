...
Future<void> main() async {
  runZonedGuarded(() async {
    ...
    debugPrint('[STARTUP] dotenv loaded (.env.dev.local): ${mainStopwatch.elapsedMilliseconds}ms');

    // Create app configuration from loaded env
    final config = AppConfig.fromEnv();
    debugPrint('[STARTUP] AppConfig created (dev flavor): ${mainStopwatch.elapsedMilliseconds}ms');

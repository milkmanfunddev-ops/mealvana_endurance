  ...
  runZonedGuarded(
    () async {
      ...
      await SentryFlutter.init((options) {
        ...
        // An armed install behaves exactly as before (every error ships its 30s
        // video); an unarmed one never starts the recorder. 0.1 here would be
        // the worst of both worlds — full battery cost, 90% of replays
        // discarded. Debug stays off outright (200+ lines of codec logs).
        // Full reasoning: sentry_replay_sampling.dart.

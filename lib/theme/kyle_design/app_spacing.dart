...
class AppRadius {
  ...
  static const BorderRadius buttonRadius = BorderRadius.all(Radius.circular(100.0));
  
  // Cards (15px from Figma)
  static const BorderRadius cardRadius = BorderRadius.all(Radius.circular(15.0));
  
  // Input fields (15px from Figma)
  static const BorderRadius inputRadius = BorderRadius.all(Radius.circular(15.0));
  
  // Activity type selector (15px from Figma)
  static const BorderRadius activitySelectorRadius = BorderRadius.all(Radius.circular(15.0));
  
  // Segmented control (15px from Figma)
  static const BorderRadius segmentedControlRadius = BorderRadius.all(Radius.circular(15.0));
}

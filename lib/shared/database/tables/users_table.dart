...
/// Users table definition for Drift - matches Supabase users table schema
...
class UsersTable extends Table {
  ...
  // Shared sport preferences (nullable)
  BoolColumn get giSensitivity => boolean().nullable().named('gi_sensitivity')(); // GI sensitivity flag

  // Sharing preferences (nullable)

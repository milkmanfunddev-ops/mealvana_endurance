...
class DailyMacroTargetsTable extends Table {
  ...
  RealColumn get sessionKcal =>
      real().withDefault(const Constant(0)).named('session_kcal')();
  ...
  TextColumn get calculationInput =>
      text().nullable().named('calculation_input')();
  TextColumn get algorithmVersion =>
      text().withDefault(const Constant('v4')).named('algorithm_version')();
  ...
  @override
  List<String> get customConstraints => ['UNIQUE(user_id, target_date)'];
}

...
class _ConnectedAppsScreenState extends ConsumerState<ConnectedAppsScreen> {
  ...
  void initState() {
    ...
    // This is onboarding step 0, and it fired no `screen_viewed` at all — so
    // the funnel had no denominator: we could see people completing step 0 but
    // never how many reached it. Every other step already tracks this.

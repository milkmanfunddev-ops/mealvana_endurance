...
class ActivitiesRepository {
  ...
  Future<domain.Activity> createActivity({
    ...
    try {
      ...
      final activityWithId = _mapToActivityDomain(savedActivity);

      // Attempt background upload (non-blocking)
      // Note: Local activity is protected by needsUpload flag during sync
      _logger.info(
        'Scheduling background upload for new activity',
      ...
      unawaited(_uploadActivityToSupabase(deviceId, activityWithId, 'create'));
  ...
  Future<void> _uploadActivityToSupabase(
    ...
    try {
      // First, get the user_id from device_id
      ...
      // Use direct Supabase upsert (handles both create and update)

...
class ActivityMapper {
  ...
  domain.Activity fromDriftRow(Activity row) {
    return _buildDomainActivity(
      ...
      garminSummaryId: row.garminSummaryId,
      garminDeviceName: row.garminDeviceName,
      tssPlanned: row.tssPlanned,
      tssActual: row.tssActual,
      ifPlanned: row.ifPlanned,
      ifActual: row.ifActual,
      tpCalories: row.tpCalories,
      tpCaloriesPlanned: row.tpCaloriesPlanned,
      parentSummaryId: row.parentSummaryId,
      isParent: row.isParent,
      hiddenByDisconnect: row.hiddenByDisconnect,
    );
  }
  ...
  domain.Activity fromJson(Map<String, dynamic> json) {
    return _buildDomainActivity(
      ...
      paceTargetMinutesPerMile: (json['pace_target_minutes_per_mile'] as num?)
          ?.toDouble(),
      ...
      cyclingElevationGainFt: (json['cycling_elevation_gain_ft'] as num?)
          ?.toInt(),
      ...
      paceMinMinutesPerMile: (json['pace_min_minutes_per_mile'] as num?)
          ?.toDouble(),
      paceMaxMinutesPerMile: (json['pace_max_minutes_per_mile'] as num?)
          ?.toDouble(),
      ...
      garminSummaryId: json['garmin_summary_id'] as String?,
      garminDeviceName: json['garmin_device_name'] as String?,
      tssPlanned: (json['tss_planned'] as num?)?.toDouble(),
      tssActual: (json['tss_actual'] as num?)?.toDouble(),
      ifPlanned: (json['if_planned'] as num?)?.toDouble(),
      ifActual: (json['if_actual'] as num?)?.toDouble(),
      tpCalories: (json['tp_calories'] as num?)?.toDouble(),
      tpCaloriesPlanned: (json['tp_calories_planned'] as num?)?.toDouble(),
      parentSummaryId: json['parent_summary_id'] as String?,
      isParent: json['is_parent'] as bool?,
      hiddenByDisconnect: json['hidden_by_disconnect'] as bool?,
    );
  }
  ...
  domain.Activity _buildDomainActivity({
    ...
    final parsedActivityType = ActivityType.fromDbValue(activityType);
    final normalizedTitle = ActivityTitleFormatter.normalizeAutoGeneratedTitle(
      title: title,
  ...
  ActivitiesTableCompanion toCompanion(
    ...
    return ActivitiesTableCompanion(
      ...
      garminSummaryId: Value(activity.garminSummaryId),
      garminDeviceName: Value(activity.garminDeviceName),
      tssPlanned: Value(activity.tssPlanned),
      tssActual: Value(activity.tssActual),
      ifPlanned: Value(activity.ifPlanned),
      ifActual: Value(activity.ifActual),
      tpCalories: Value(activity.tpCalories),
      tpCaloriesPlanned: Value(activity.tpCaloriesPlanned),
      parentSummaryId: Value(activity.parentSummaryId),
      isParent: Value(activity.isParent),
      hiddenByDisconnect: Value(activity.hiddenByDisconnect),
    );
  }
  ...
  Map<String, dynamic> buildSupabasePayload(
    ...
    return {
      ...
      'tss_planned': activity.tssPlanned,
      'tss_actual': activity.tssActual,
      'if_planned': activity.ifPlanned,
      'if_actual': activity.ifActual,
      'tp_calories': activity.tpCalories,
      'tp_calories_planned': activity.tpCaloriesPlanned,
      'parent_summary_id': activity.parentSummaryId,
      'is_parent': activity.isParent,
      'hidden_by_disconnect': activity.hiddenByDisconnect,
  ...
  Map<String, dynamic> buildUploadPayloadFromRow(Activity record) {
    ...
    return {
      ...
      'tss_planned': record.tssPlanned,
      'tss_actual': record.tssActual,
      'if_planned': record.ifPlanned,
      'if_actual': record.ifActual,
      'tp_calories': record.tpCalories,
      'tp_calories_planned': record.tpCaloriesPlanned,
      'parent_summary_id': record.parentSummaryId,
      'is_parent': record.isParent,
      'hidden_by_disconnect': record.hiddenByDisconnect,

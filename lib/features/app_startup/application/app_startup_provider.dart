...
class AppStartup extends _$AppStartup {
  ...
  Future<AppStartupData> build() async {
    ...
    try {
      ...
      // 2a. GRACE CLAIM RETRY (mp-561): an old install whose grace-month
      // claim got no answer claims again, before the gate reads the status.
      // A no-op for everyone else; never throws.
      await PerformanceTelemetry.measure(
        'startup.grace_claim_retry',
        startupService.retryPendingGraceClaim,
      );

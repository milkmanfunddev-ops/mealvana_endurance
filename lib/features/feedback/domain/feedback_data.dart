/// Domain types for the feedback repository.
///
/// The survey/poll UI that used to own this file was deleted on 2026-08-05 —
/// it was unreachable (nothing outside the feature instantiated its screens or
/// read its providers). What survives is only what
/// `data/feedback_repository.dart` still needs: the survey response payload it
/// syncs, and its confidence enum.
///
/// NOTE: there is a second, unrelated `ConfidenceLevel` in
/// `nutrition_plan/domain/nutrient_transparency_data.dart`. They are different
/// types with the same name — import deliberately.

...
/// Second page of survey: Reminder setup or feedback on missed expectations (Simple version)
class SurveyPage2Simple extends ConsumerWidget {
  const SurveyPage2Simple({
    super.key,

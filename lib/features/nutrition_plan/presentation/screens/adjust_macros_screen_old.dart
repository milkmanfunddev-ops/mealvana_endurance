...
//   Widget _buildContent(BuildContext context, WidgetRef ref, MacroTargetsState state) {
...
//       case ActivityType.multisport:
//         label = 'Distance';
//         value = '${macros.metrics.distanceMi.toStringAsFixed(1)} miles';
//         break;
//     }
...
//   Widget _buildOpenMacroLayout(BuildContext context, WidgetRef ref, MacroTargets macros, MacroTargetsState state) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
...
//               ),
//               child: IconButton(
//                 onPressed: () => _showEditAllMacrosDialog(context, ref, macros, state.activityId),
//                 icon: Icon(
//                   Icons.edit,
//                   color: AppTheme.primary600,
//                   size: 20.w,
...
//             children: [
//               // Header row
//               _buildHeaderRow(context, ref, state),
...
//   Widget _buildHeaderRow(BuildContext context, WidgetRef ref, MacroTargetsState state) {
//     return Row(
//       children: [
...
//             });
//             _showHelpBottomSheet(context, ref, state.activityId);
//           },
//           child: Container(
...
//   Widget _buildActionButtons(BuildContext context, WidgetRef ref, MacroTargetsState state) {
//     return Column(
//       children: [
//         // Reset All Button
//         TextButton.icon(
//           onPressed: state.isCreatingPlan ? null : () {
//             ref.read(macroTargetsControllerProvider.notifier)
//                 .resetToRecommended();
//           },
//           icon: Icon(
//             Icons.refresh,
...
//             await ref.read(macroTargetsControllerProvider.notifier)
//                 .createNutritionPlan();
...
//   void _showEditAllMacrosDialog(
//       BuildContext context, WidgetRef ref, MacroTargets macros, int? activityId) {
...
//   void _showHelpBottomSheet(BuildContext context, WidgetRef ref, int? activityId) {
//     final analytics = ref.read(appExternalDepsProvider).analytics;
...
//     try {
//       final controller = ref.read(macroTargetsControllerProvider.notifier);

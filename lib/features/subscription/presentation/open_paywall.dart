...
/// there. Screens call it with their router; a refused write in a controller
/// asks through `paywallRequestsProvider` instead, and `PlanEndedHost` calls
/// this on its behalf. A paywall already on top is left alone.
library;

...
export function renderReport({ summary: s, wrong = [], geometryVersion, at, wrongShown = 40 }) {
  ...
  l.push('`node scripts/_archived/meal-images/09-image-report.mjs --write`; do not edit by hand._');
  l.push('');
  ...
  if (wrong.length) {
    ...
    if (wrong.length > wrongShown) {
      ...
      l.push('`node scripts/_archived/meal-images/09-image-report.mjs --wrong`');
    }
  } else {
    l.push('_None._');
  }

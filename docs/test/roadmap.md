...
- [x] Create Vitest configuration in `test/local_edge_functions/` (package.json, vitest.config.ts, tsconfig.json)
...
- Edge test commands:
  - Vitest: `cd test/local_edge_functions && npm test` (or `vitest run`).

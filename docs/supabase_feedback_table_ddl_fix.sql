-- URGENT FIX: Update the reuse_intent column type to TEXT
-- Run this command in your Supabase SQL editor to fix the data type mismatch
...
CREATE TABLE IF NOT EXISTS feedback (
    ...
    reuse_intent TEXT, -- ✅ Changed from INTEGER to TEXT

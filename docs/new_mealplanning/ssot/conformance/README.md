...
prototype  108 passed · 2 failed (EXPECTED-RED, D-11) · 1 skipped
...
| Gap | Why | Next step |
|---|---|---|
| athlete-context arithmetic, day-guidance table, batch re-derive, on-hand re-ranking, cooking timers (TS) | logic inside DB-bound or unexported functions | extract pure functions (Q-AC1, Q-DG1, Q-CS2, Q-SG1, D-13), then add vectors |

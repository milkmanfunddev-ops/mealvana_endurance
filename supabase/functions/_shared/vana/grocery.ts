...
const AISLE_RULES: Array<[string, string[]]> = [
  ...
  ['Bakery & Grains', ['bread','tortilla','pita','bagel','muffin','naan','rice','quinoa','couscous','barley','oats','oatmeal','pasta','noodle','spaghetti','penne','lasagn','ramen','soba','bun','polenta','ugali','injera','cornflakes','cereal','granola','crackers','rice cake','wrap','flour','farro','spelt','freekeh','bulgur','bulghur','millet','buckwheat','amaranth','sorghum','teff']],

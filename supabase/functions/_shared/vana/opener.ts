...
export function pickOpener(input: { today: string; current: (MealPlan & { checkinDoneAt?: string | null }) | null; previous: (MealPlan & { debriefDoneAt?: string | null }) | null; periodDays?: number }): OpenerVariant {

...
const RANDOM_PICK_MARGIN = 0.08; // Keep slight variety among near-equal safe candidates
const RANDOM_PICK_LIMIT = 3;     // Avoid broad randomness that can drift output

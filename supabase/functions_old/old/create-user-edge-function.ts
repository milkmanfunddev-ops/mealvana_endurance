...
serve(async (req) => {
  ...
  try {
    ...
    const { device_id, gender, birthday, height_feet, height_inches, weight_pounds, runs_with_water_bottle, gut_training_level, food_preferences, app_version } = await req.json() as CreateUserRequest

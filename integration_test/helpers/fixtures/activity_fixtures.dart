...
class ActivityFixtures {
  ...
  static Map<String, dynamic> get fiveK => {
        ...
        'sport_type': 'running',
        'activity_type': 'race',
        'activity_date': DateTime.now().add(const Duration(days: 7)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get tenK => {
        ...
        'sport_type': 'running',
        'activity_type': 'race',
        'activity_date': DateTime.now().add(const Duration(days: 14)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get halfMarathon => {
        ...
        'sport_type': 'running',
        'activity_type': 'race',
        'activity_date': DateTime.now().add(const Duration(days: 30)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get marathon => {
        ...
        'sport_type': 'running',
        'activity_type': 'race',
        'activity_date': DateTime.now().add(const Duration(days: 60)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get ultraMarathon => {
        ...
        'sport_type': 'running',
        'activity_type': 'race',
        'activity_date': DateTime.now().add(const Duration(days: 90)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get century => {
        ...
        'activity_date': DateTime.now().add(const Duration(days: 21)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> get longRun => {
        ...
        'sport_type': 'running',
        'activity_type': 'training',
        'activity_date': DateTime.now().add(const Duration(days: 3)).toIso8601String(),
      };
  ...
  static Map<String, dynamic> custom({
    ...
    return {
      ...
      'activity_date': (activityDate ?? DateTime.now().add(const Duration(days: 7)))
          .toIso8601String(),
    };
  }

  /// Helper to calculate total duration from pace and distance
  static Duration calculateDuration(double distanceMiles, int paceMinutes, int paceSeconds) {

...
- [x] The gate answers open, lapsed or never from fake customer info (through the real notifier).
- [x] Lapsed reaches app routes with the bar; never is redirected to the paywall (redirect test).
- [x] AI entry points open the paywall for a lapsed account.

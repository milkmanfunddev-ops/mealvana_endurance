...
- [x] Each write controller refuses while lapsed (one seam test per controller write path, through the real notifier).
- [x] Nothing is written locally or queued while lapsed.
- [x] An active account writes as before (the full suite stays green).

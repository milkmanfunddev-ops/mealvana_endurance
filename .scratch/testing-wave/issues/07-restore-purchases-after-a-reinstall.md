...
- [x] After uninstall and reinstall, sign-in either opens the app or offers Restore; Restore opens it; RevenueCat shows no second purchase. (Wave 6: sign-in opened the app, so the Restore branch never ran; a Test Store purchase survives a reinstall, 07-001. The Restore branch moves to 07-006, the Apple sandbox run.)

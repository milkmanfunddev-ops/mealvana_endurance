...
**Setup:** 87-006 and 87-009 need a Test Store monthly (5-minute periods, ends after five): plan around the 25-minute lapse, and let the same accounts serve the Lapsed checks (87-007, 87-008, 05-008, 09-011, 10-003, 10-005) once they lapse. 07-008, 08-005 and 07-011 need a paid account inside its period. New accounts only; no check here uses test@test.com.

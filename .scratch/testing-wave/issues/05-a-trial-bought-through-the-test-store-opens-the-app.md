...
- [x] The webhook answer (fires or not, and why) is written as a Finding of kind idea or bug, with the edge-function log.
- [x] The paid account is kept in the credentials file (not deleted) for tickets 06 to 09 and marked so; ticket 10 deletes it.

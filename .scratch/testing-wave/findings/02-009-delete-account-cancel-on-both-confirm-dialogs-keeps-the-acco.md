...
Run by retest ticket 125 (run w37-20260926T0221Z, build 72d3723e): pass; Cancel and tap-outside on the delete dialog, from Settings and from the paywall menu, keep the account, its rows and the session.

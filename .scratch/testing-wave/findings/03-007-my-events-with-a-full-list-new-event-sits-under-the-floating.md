...
first step for this account; a `scrollTo` drag (which overscrolls) did reach it, and both flows
pass with that (test code, this ticket). An athlete has to hit the sliver above the bar.

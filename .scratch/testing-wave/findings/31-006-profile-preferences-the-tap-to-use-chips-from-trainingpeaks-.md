...
Run by retest ticket 119 (run w36-20260926T0031Z, build 72d3723e): pass; each chip fills only its own field and nothing is written without Save. The TrainingPeaks chips show while TrainingPeaks needs reconnecting.

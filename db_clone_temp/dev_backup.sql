...
CREATE TABLE IF NOT EXISTS "public"."nutrition_plans" (
    ...
    CONSTRAINT "nutrition_plans_plan_type_check" CHECK (("plan_type" = ANY (ARRAY['standard'::"text", 'carb_loading'::"text", 'recovery'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."feature_survey_responses" (
    ...
    "voted_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
ALTER TABLE ONLY "public"."feature_survey_responses"
    ADD CONSTRAINT "unique_device_vote" UNIQUE ("device_id");
...
CREATE INDEX "idx_activities_needs_upload" ON "public"."activities" USING "btree" ("needs_upload", "user_id") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_activity_completions_needs_upload" ON "public"."activity_completions" USING "btree" ("needs_upload", "user_id") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_carb_loading_days_needs_upload" ON "public"."carb_loading_days" USING "btree" ("needs_upload") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_carb_loading_plans_needs_upload" ON "public"."carb_loading_plans" USING "btree" ("needs_upload", "user_id") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_events_needs_upload" ON "public"."events" USING "btree" ("needs_upload", "user_id") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_feature_survey_responses_device_id" ON "public"."feature_survey_responses" USING "btree" ("device_id");
...
CREATE INDEX "idx_nutrition_plans_needs_upload" ON "public"."nutrition_plans" USING "btree" ("needs_upload", "device_id") WHERE ("needs_upload" = true);
...
CREATE INDEX "idx_user_foods_needs_upload" ON "public"."user_foods" USING "btree" ("needs_upload", "device_id") WHERE ("needs_upload" = true);
...
CREATE POLICY "Anyone can insert feature survey votes" ON "public"."feature_survey_responses" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);
...
CREATE POLICY "Anyone can read feature survey votes" ON "public"."feature_survey_responses" FOR SELECT TO "authenticated", "anon" USING (true);
...
CREATE POLICY "Service role full access to feature survey votes" ON "public"."feature_survey_responses" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can delete their own events" ON "public"."events" FOR DELETE USING (("user_id" = ("auth"."uid"())::"text"));
...
CREATE POLICY "Users can insert their own events" ON "public"."events" FOR INSERT WITH CHECK (("user_id" = ("auth"."uid"())::"text"));
...
CREATE POLICY "Users can update their own events" ON "public"."events" FOR UPDATE USING (("user_id" = ("auth"."uid"())::"text"));



CREATE POLICY "Users can view their own events" ON "public"."events" FOR SELECT USING (("user_id" = ("auth"."uid"())::"text"));
